...
# /tmp dizini izinlerini kontrol et ve düzelt
echo "Kontrol ediliyor /tmp dizini izinleri..."
sudo chmod 1777 /tmp
check_success "/tmp dizini izinlerini ayarlama"

# Geçici indirme dizini oluşturma
TEMP_DIR="/tmp/prestashop_download"
...
sudo wget "$PRESTASHOP_URL" -O prestashop_latest.zip
check_success "PrestaShop sürümünü indirme"

# PrestaShop dosyalarını çıkarma
echo "PrestaShop dosyaları çıkarılıyor..."
...
sudo rm -rf $TEMP_DIR
check_success "Geçici dosyaların temizlenmesi"
